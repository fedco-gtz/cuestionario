                        ...
                        <div className="modalContent">
                            ...
                            <div className="mathTools">
                                {[
                                    ...
                                    { label: "}", syntax: "$\\}$" },
                                    { label: "{a,b}", syntax: "$\{ a,b \}$" },
                                    { label: "sen(x)", syntax: "$\\sin(x)$" },
                                    { label: "cos(x)", syntax: "$\\cos(x)$" },
                                    { label: "tan(x)", syntax: "$\\tan(x)$" },
                                    { label: "arcsen(x)", syntax: "$\\arcsin(x)$" },
                                    { label: "arccos(x)", syntax: "$\\arccos(x)$" },
                                    { label: "arctan(x)", syntax: "$\\arctan(x)$" },
